                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        support@vibrantcart.com<br />
                        info@vibrantcart.com
                      </p>
                    </div>
                  </div>
            ...
            <div className="rounded-lg overflow-hidden h-[400px] shadow-md">
              <div className="w-full h-full bg-muted flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-lg font-medium">Interactive Map Would Appear Here</p>
                  <p className="text-gray-500">This would be replaced with a real map in production</p>
                </div>
              </div>
            </div>
          </div>
